...
public class FlowLayoutDemo2 {
	...
	public static void main(String[] args) {
		...
		p3.add(jButton11, BorderLayout.EAST);
		p3.add(jButton12, BorderLayout.SOUTH);
		p3.add(jButton13, BorderLayout.WEST);
		p3.add(jButton14, BorderLayout.NORTH);
		p3.add(jButton15, BorderLayout.CENTER);
